...
class MenuCard {
  ...
  // FETCH API
  fetch("https://jsonplaceholder.typicode.com/todos/1")      // в скобки помещается тот url на который мы будем посылать запрос для получения данных, из данной конструкции нам возвращается Promise
